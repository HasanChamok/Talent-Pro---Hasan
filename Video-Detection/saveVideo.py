    ...
    if request.method == 'POST':
        ...
        if 'file' in request.files:
            ...
            while True:
                ...
                video_filename_without_extension = os.path.splitext(os.path.basename(video_file.filename))[0]

                # Create a directory for the current video if it doesn't exist
                video_output_folder = os.path.join(basepath, 'Detected_Videos', video_filename_without_extension)
